...
// -----  CONSTRUCTORS                                                 -----
// -------------------------------------------------------------------------
SMD_AVR0_Serial::SMD_AVR0_Serial()  // instantiate with default baudrate,
...
void SMD_AVR0_Serial::clearInputBuffer() {
	recvbuf_read_idx = 0;
	recvbuf_write_idx = 0;
}
...
// -----  RECEIVING                                                    -----
// -------------------------------------------------------------------------
uint8_t SMD_AVR0_Serial::getByte() {
...
bool SMD_AVR0_Serial::inWaiting() {
